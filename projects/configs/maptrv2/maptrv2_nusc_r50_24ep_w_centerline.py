...
data_root = '/mnt/j/bevfusion/data/nuscenes'
...
train_pipeline = [
    ...
    dict(type='DefaultFormatBundle3D', with_gt=True, with_label=True,class_names=map_classes),
...
data = dict(
    ...
    val=dict(
        ...
        map_ann_file=data_root + '/nuscenes_map_infos_temporal_val.pkl',
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + '/nuscenes_map_infos_temporal_test.pkl',
        map_ann_file=data_root + '/nuscenes_map_infos_temporal_test.pkl',
...
lr_config = dict(
    ...
    min_lr_ratio=1e-3)
total_epochs = 24
evaluation = dict(interval=30, pipeline=test_pipeline, metric='chamfer',
